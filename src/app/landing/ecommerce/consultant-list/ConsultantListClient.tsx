                ...
                <div className="relative z-10 max-w-6xl mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl overflow-hidden my-8">
                    ...
                    <div className="p-12 space-y-8">
                        ...
                        <div className="card-hover bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 text-white rounded-3xl p-8 shadow-2xl border-2 border-orange-300/20">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    ...
                                    <ul className="space-y-3 text-white/90 text-lg leading-relaxed">
                                        <li>• User experience audits, A/B testing</li>
                                        <li>• Checkout optimization, mobile responsiveness</li>
                                        <li>• Product page design, site performance</li>
                                    </ul>
                                </div>
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-orange-100">⚡ When to hire:</h3>
                                    <p className="text-white/90 text-lg leading-relaxed">Low conversion rates, poor user experience metrics</p>
                                </div>
                            </div>
                        </div>

                        {/* 5. Supply Chain & Operations Consultants */}
                        <div className="card-hover bg-gradient-to-br from-teal-600 via-cyan-600 to-blue-600 text-white rounded-3xl p-8 shadow-2xl border-2 border-teal-300/20">
                            <div className="flex items-center mb-6">
                                <span className="text-4xl mr-4">📦</span>
                                <h2 className="text-3xl font-bold">5. Supply Chain & Operations Consultants</h2>
                            </div>
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-teal-100">✨ What they do:</h3>
                                    <ul className="space-y-3 text-white/90 text-lg leading-relaxed">
                                        <li>• Inventory management, forecasting</li>
                                        <li>• Warehousing, fulfillment, shipping optimization</li>
                                        <li>• Supplier relationships, cost reduction</li>
                                    </ul>
                                </div>
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-teal-100">⚡ When to hire:</h3>
                                    <p className="text-white/90 text-lg leading-relaxed">Scaling operations, supply chain issues, cost optimization</p>
                                </div>
                            </div>
                        </div>

                        {/* 6. Data Analytics & BI Consultants */}
                        <div className="card-hover bg-gradient-to-br from-violet-600 via-purple-600 to-pink-600 text-white rounded-3xl p-8 shadow-2xl border-2 border-violet-300/20">
                            <div className="flex items-center mb-6">
                                <span className="text-4xl mr-4">📊</span>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-violet-100">✨ What they do:</h3>
                                    <ul className="space-y-3 text-white/90 text-lg leading-relaxed">
                                        <li>• Data pipeline setup, KPI tracking</li>
                                        <li>• Customer analytics, cohort analysis</li>
                                        <li>• Business intelligence dashboards, reporting automation</li>
                                    </ul>
                                </div>
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-violet-100">⚡ When to hire:</h3>
                                    <p className="text-white/90 text-lg leading-relaxed">Data-driven decision making, performance tracking, scaling insights</p>
                                </div>
                            </div>
                        </div>

                        {/* 7. Branding & Creative Consultants */}
                        <div className="card-hover bg-gradient-to-br from-rose-600 via-pink-600 to-purple-600 text-white rounded-3xl p-8 shadow-2xl border-2 border-rose-300/20">
                            <div className="flex items-center mb-6">
                                <span className="text-4xl mr-4">🎭</span>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                                    <h3 className="font-bold mb-4 text-xl text-rose-100">✨ What they do:</h3>
                                    <ul className="space-y-3 text-white/90 text-lg leading-relaxed">
