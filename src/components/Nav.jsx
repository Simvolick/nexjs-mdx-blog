  ...
  return (
    <nav className='p-3'>
        <div className='text-center m-3 flex flex-row'>
            <div className='cursor-pointer text-lg font-semibold md:mx-20 '>
            <Link href='/' className=''>
                <div alt="Клим Ядринцев">
                    <div className='mx-2'>
                        <Image className="rounded-full" src={KlimsImage} alt="Klim Yadrintsev Photo" width={50} height={50} />
                    </div>
            ...
            <div className='mx-5 flex flex-row items-center  text-gray-700 '>
                ...
                <Link href='/blog'>
                    <h2 className='ms-5 cursor-pointer px-5 py-2 rounded-xl mx-2'>Blog</h2>
                </Link>
            </div>
            </div>
        </div>
